...
<div class="form-container">
    <form action="#" method="post">
        <input type="text" class="name" name="name" placeholder="Nombre del rol" required>
        <input type="text" class="description" name="description" placeholder="Descripción del rol" required>
